...
//       Store M0
    ...
    //                    0x50     M0 Voltage Set
  this->publish_state_(this->M0_50_sensor_, (float) xy6020_get_16bit(18) * 0.1f);    
    //                0x51     M0 Current Set
  this->publish_state_(this->M0_51_sensor_, (float) xy6020_get_16bit(19) * 0.1f);
  ...
  this->publish_state_(this->M0_53_sensor_, (float) xy6020_get_16bit(21) * 0.1f);
    //                0x54    OPP
