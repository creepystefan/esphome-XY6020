...
void xy6020::on_status_data_(const std::vector<uint8_t> &data) {
  ...
  // *Data*
    ...
    // -> 0x01 0x03 0x00 0x00 0x00 0x0D 0x84 0x0F
    // Status response
    // <- 0x01 0x03 0x1A 0x09 0x60 0x07 0xCF 0x09 0x60 0x00 0x0B 0x00 0x1A 0x12 0xD9 0x13 
    //    0xD4 0x00 0x00 0x5A 0x49 0x00 0x02 0x00 0x37 0x00 0x13 0x00 0x2A 0x02 0x61    
