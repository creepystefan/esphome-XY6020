...
//                    0x59
  this->publish_state_(this->M0_59_sensor_, (float) xy6020_get_16bit(44) * 0.01f);
    ...
    //           Store M1
    //                    0x60     M1 Voltage Set
  this->publish_state_(this->M0_60_sensor_, (float) xy6020_get_16bit(0xa0) * 1.f);    
    //                0x61     M1 Current Set
  this->publish_state_(this->M0_61_sensor_, (float) xy6020_get_16bit(0xa2) * 1.f);
    //                0x62    OVP Over Voltage Protect
  this->publish_state_(this->M0_62_sensor_, (float) xy6020_get_16bit(0xa4) * 1.f);
    //                0x63    OCP Over Current Protect
  this->publish_state_(this->M0_63_sensor_, (float) xy6020_get_16bit(0xa6) * 1.f);
    //                0x64    OPP
  this->publish_state_(this->M0_64_sensor_, (float) xy6020_get_16bit(0xa8) * 1.f);
    //                0x65    ??  b_led2_set_max
