...
//       Store M0
  ...
  this->publish_state_(this->M0_50_sensor_, (float) xy6020_get_16bit(18) * 1.f);    
    //                0x51     M0 Current Set
  this->publish_state_(this->M0_51_sensor_, (float) xy6020_get_16bit(46) * 1.f);
  ...
  this->publish_state_(this->M0_53_sensor_, (float) xy6020_get_16bit(32));
    //                0x54    OPP
...
//                    0x59
  this->publish_state_(this->M0_59_sensor_, (float) xy6020_get_16bit(44) * 0.01f);
    ...
    //           Store M1
    //                    0x60     M1 Voltage Set
  this->publish_state_(this->M0_60_sensor_, (float) xy6020_get_16bit(0x80) * 1.f);    
    //                0x61     M1 Current Set
  this->publish_state_(this->M0_61_sensor_, (float) xy6020_get_16bit(0x81) * 1.f);
    //                0x62    OVP Over Voltage Protect
  this->publish_state_(this->M0_62_sensor_, (float) xy6020_get_16bit(0x82) * 1.f);
    //                0x63    OCP Over Current Protect
  this->publish_state_(this->M0_63_sensor_, (float) xy6020_get_16bit(0x83) * 1.f);
    //                0x64    OPP
  this->publish_state_(this->M0_64_sensor_, (float) xy6020_get_16bit(0x84) * 1.f);
    //                0x65    ??  b_led2_set_max
  this->publish_state_(this->M0_65_sensor_, (float) xy6020_get_16bit(170) * 0.01f);
    //                0x66    ??  m_pre_set_max, self.limits.m_pre_set_min
  this->publish_state_(this->M0_66_sensor_, (float) xy6020_get_16bit(172) * 0.01f);
    //                0x67    ??
  this->publish_state_(this->M0_67_sensor_, (float) xy6020_get_16bit(87) * 0.01f);
    //                0x68    ??
  this->publish_state_(this->M0_68_sensor_, (float) xy6020_get_16bit(88) * 0.01f);
//                    0x69    ??
  this->publish_state_(this->M0_69_sensor_, (float) xy6020_get_16bit(89) * 0.01f);

    //                    0x50     M2 Voltage Set
 // this->publish_state_(this->70_sensor_, (float) xy6020_get_16bit(160) * 0.01f);    
    //                0x51     M1 Current Set
 // this->publish_state_(this->71_sensor_, (float) xy6020_get_16bit(162) * 0.01f);
    //                0x52    OVP Over Voltage Protect
 // this->publish_state_(this->72_sensor_, (float) xy6020_get_16bit(0x52) * 0.01f);
    //                0x53    OCP Over Current Protect
 // this->publish_state_(this->73_sensor_, (float) xy6020_get_16bit(0x53) * 0.01f);
    //                0x54    OPP
 // this->publish_state_(this->74_sensor_, (float) xy6020_get_16bit(0x54) * 0.01f);
    //                0x55    b_led2_set_max
 // this->publish_state_(this->75_sensor_, (float) xy6020_get_16bit(0x55) * 0.01f);
    //                0x56    m_pre_set_max, self.limits.m_pre_set_min
 // this->publish_state_(this->76_sensor_, (float) xy6020_get_16bit(0x56) * 0.01f);
    //                0x57    s_ini_set_max, self.limits.s_ini_set_min
 // this->publish_state_(this->77_sensor_, (float) xy6020_get_16bit(0x57) * 0.01f);
    //                0x58
 // this->publish_state_(this->78_sensor_, (float) xy6020_get_16bit(0x58) * 0.01f);
//                    0x59
//  this->publish_state_(this->79_sensor_, (float) xy6020_get_16bit(0x59) * 0.01f);
  ...
  //  46     0073           Firmware version                   115 = 11.5
    this->publish_state_(this->firmware_version_sensor_, xy6020_get_16bit(34));
}    
