...
//       Store M0
    ...
    //                    0x50     M0 Voltage Set
  this->publish_state_(this->M0_50_sensor_, (float) xy6020_get_16bit(0x01) * 0.01f);    
    //                0x51     M0 Current Set
  this->publish_state_(this->M0_51_sensor_, (float) xy6020_get_16bit(0x02) * 0.01f);
...
void xy6020::update() {
  ...
  this->send(FUNCTION_READ_REGISTERS, 0x0000, 0x002D);
}
