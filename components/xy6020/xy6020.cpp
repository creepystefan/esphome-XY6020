...
//       Store M0
    ...
    //                    0x50     M0 Voltage Set
  this->publish_state_(this->M0_50_sensor_, (float) xy6020_get_16bit(0x80) == 0x0001);    
    //                0x51     M0 Current Set
  this->publish_state_(this->M0_51_sensor_, (float) xy6020_get_16bit(0x81) == 0x0001);
    //                0x52    OVP Over Voltage Protect
  this->publish_state_(this->M0_52_sensor_, (float) xy6020_get_16bit(0x82) == 0x0001);
    //                0x53    OCP Over Current Protect
  this->publish_state_(this->M0_53_sensor_, (float) xy6020_get_16bit(0x83) == 0x0001);
    //                0x54    OPP
