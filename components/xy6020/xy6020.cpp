...
//       Store M0
    ...
    //                    0x50     M0 Voltage Set
  this->publish_state_(this->M0_50_sensor_, (float) xy6020_get_16bit(0x50) * 0.1f);    
    //                0x51     M0 Current Set
  this->publish_state_(this->M0_51_sensor_, (float) xy6020_get_16bit(0x51) * 0.1f);
    //                0x52    OVP Over Voltage Protect
  this->publish_state_(this->M0_52_sensor_, (float) xy6020_get_16bit(0x52) * 0.1f);
    //                0x53    OCP Over Current Protect
  this->publish_state_(this->M0_53_sensor_, (float) xy6020_get_16bit(0x53) * 0.1f);
    //                0x54    OPP
...
//  this->publish_state_(this->59_sensor_, (float) xy6020_get_16bit(0x59) * 0.01f);
  ...
  bool output = xy6020_get_16bit(14) == 0x0001;
